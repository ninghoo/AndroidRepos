...
{
    // 控制当前卡片和后一张卡片的大小。
    private static final float DEFAULT_CURRENT_PAGE_SCALE = 0.88f;
    private static final float DEFAULT_TOP_STACKED_SCALE = 0.6f;
    ...
    public void initStack(int numberOfStacked) {
        initStack(numberOfStacked, StackPageTransformer.Orientation.VERTICAL, DEFAULT_CURRENT_PAGE_SCALE, DEFAULT_TOP_STACKED_SCALE, DEFAULT_OVERLAP_FACTOR, StackPageTransformer.Gravity.BOTTOM);
    }
